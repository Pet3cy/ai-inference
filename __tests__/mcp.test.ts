...
describe('mcp.ts', () => {
  ...
  describe('executeToolCalls', () => {
    ...
    it('executes a single tool call and returns a single-element array', async () => {
    ...
    it('result at each index matches the tool_call_id of the corresponding input', async () => {
      const toolCalls = [
        {id: 'alpha', type: 'function', function: {name: 'tool-alpha', arguments: '{}'}},
        {id: 'beta', type: 'function', function: {name: 'tool-beta', arguments: '{}'}},
        {id: 'gamma', type: 'function', function: {name: 'tool-gamma', arguments: '{}'}},
      ]
      ...
      expect(results[0].tool_call_id).toBe('alpha')
      expect(results[1].tool_call_id).toBe('beta')
      expect(results[2].tool_call_id).toBe('gamma')
    })
